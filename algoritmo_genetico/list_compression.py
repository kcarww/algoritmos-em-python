...
class ListCompression(Chromosome):
    ...
    def crossover(self, other: ListCompression) -> Tuple[ListCompression, ListCompression]:
        ...
        l1, l2 = child1.lst[idx1], child1.lst[idx2]
        child1.lst[child1.lst.index(l1)], child1.lst[child1.lst.index(l2)] = child1.lst[child1.lst.index(l2)], child1.lst[child1.lst.index(l1)]
        child2.lst[child2.lst.index(l1)], child2.lst[child2.lst.index(l2)] = child2.lst[child2.lst.index(l2)], child2.lst[child2.lst.index(l1)]
...
if __name__ == '__main__':
    ...
    ga: GeneticAlgorithm[ListCompression] = GeneticAlgorithm(initial_population=initial_population, threshold=1.0, max_generations=100, mutation_chance=0.2, crossover_chance=0.7)
